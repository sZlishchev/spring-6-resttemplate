...
public class OAuthClientInterceptor implements ClientHttpRequestInterceptor {
    ...
    public ClientHttpResponse intercept(HttpRequest request, byte[] body, ClientHttpRequestExecution execution) throws IOException {
        final var oAuth2AuthorizedRequest = OAuth2AuthorizeRequest
                .withClientRegistrationId(clientRegistration.getRegistrationId())
                .principal(buildPrincipal())
                .build();
        
        final var client = manager.authorize(oAuth2AuthorizedRequest);
    ...
    private Authentication buildPrincipal() {
